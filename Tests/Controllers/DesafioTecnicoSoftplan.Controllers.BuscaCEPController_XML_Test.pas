unit DesafioTecnicoSoftplan.Controllers.BuscaCEPController_XML_Test;
interface
...
type
   [TestFixture]
   TBuscaCEPController_XML_Test = class
   strict private
...
{ TBuscaCEPController_XML_Test }

procedure TBuscaCEPController_XML_Test.pesquisaPorCep(const prCepDigitado: String; prAtualizar: Boolean);
var
...
procedure TBuscaCEPController_XML_Test.pesquisaPorCepExistente_MostrarMensagem(const prCepDigitado: String);
var
   wCepUsarNaBusca : Integer;
...
procedure TBuscaCEPController_XML_Test.pesquisaPorCepInexistente(const prCepDigitado: String);
var
   wCepUsarNaBusca : Integer;
begin
   FValidacoesBuscaCEP.validarCep(prCepDigitado, wCepUsarNaBusca);
...
procedure TBuscaCEPController_XML_Test.pesquisarPorEndereco(const prUF, prCidade, prLogradouro: String; prAtualizar: Boolean);
var
...
procedure TBuscaCEPController_XML_Test.pesquisarPorEnderecoExistente_MostrarMensagem(const prUF, prCidade, prLogradouro: String);
var
   wPossuiMaisCeps : Boolean;
   wMensagemEsperada : String;
begin
...
procedure TBuscaCEPController_XML_Test.pesquisarPorEnderecoInexistente(const prUF, prCidade, prLogradouro: String);
var
   wPossuiMaisCeps : Boolean;
begin
   FValidacoesBuscaCEP.validarEntradasParaEndereco(prUF, prCidade, prLogradouro);
...
procedure TBuscaCEPController_XML_Test.Setup;
begin
   FConexaoBD := TConexaoBDSQLite.Create;
   FDAOCep := TDAOCep.Create(FConexaoBD);
   FBuscadorViaCEP := TBuscadorViaCEP.Create;
   FComponenteBuscaViaCEP := TBuscaViaCEPXML.Create(FBuscadorViaCEP);
...
procedure TBuscaCEPController_XML_Test.TearDown;
begin
end;
